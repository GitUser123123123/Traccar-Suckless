# Traccar-Suckless
!YOU NEED IP OF YOUR TAILSCALE PC, NOT PHYSICAL (neither if general network)!
...
My project is a suckless alternative: it weighs 8 MB, runs with a single command on any init system, and does exactly what a tracker is supposed to do — collect and display coordinates without unnecessary garbage, my phone just can't stand up with traccar, which is why it exists.
